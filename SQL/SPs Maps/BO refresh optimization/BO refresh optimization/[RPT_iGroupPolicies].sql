...
-- Jatin Mehta : 05/20/2019 : To restrict the data of table [dbo].[Temp_GroupPolicies] for three years i.e current +- 1  
CREATE Proc [dbo].[RPT_iGroupPolicies]    
As    
...
and YEAR(g.GroupEffDate) IN (SELECT Years FROM dbo.udfGetPrevCurrNextYears())
order by --g.RowID,    
g.GroupID,g.GroupNumber,g.GroupEffDate    
