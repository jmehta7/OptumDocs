...
-- Jatin Mehta : 05/20/2019 : To restrict the data of table dbo.Temp_GroupBenSys for three years processing i.e current +- 1  

ALTER Proc [dbo].[RPT_iGroupBenSys]    
As    
...
DELETE FROM [dbo].[Temp_GroupBenSys] where
GroupID IN ( select GroupID from [Group] GP WITH(NOLOCK)        
