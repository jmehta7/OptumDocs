...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Temp_HospitalCopay]') AND type in (N'U'))    
  ...
  Where BenefitID IN (  
  Select BenefitID from dbo.#Temp_HospitalCopay thc  inner join [Group] gp  WITH(NOLOCK) ON thc.GroupID = gp.GroupID  
...
(bd1.CopayMinAmount as varchar) + ' ' + '-' + ' ' + Cast(bd1.CopayMaxAmount as varchar))       
  ...
  bdt1_Tier1.CoPayMaxAmount AND bd1.CopayMinAmount = bd1.CopayMaxAmount and bd1.CopayMinAmount IS NOT NULL      
     THEN         
  (Cast(bdt1_Tier1.CoPayMinAmount AS varchar)+' '+ '-' + ' '+CAST(bdt1_Tier1.CopayMaxAmount as varchar) +  ' '+ '/' + ' ' +CAST(bdt1_Tier2.CopayMinAmount as varchar)+' ' + '-' + ' ' + CAST(bdt1_Tier2.CoPayMaxAmount as varchar) + ' ' + '/' + ' ' + CAST(bd1
.copayMinamount as varchar))       
...
ayMaxAmount as varchar))             
  WHEN bdt1_Tier2.TierID IS NOT NULL AND bdt1_Tier1.TierID IS NOT NULL       
     ...
     THEN         
 (Cast(bdt1_Tier1.CoPayMinAmount AS varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CopayMinAmount as varchar)+' ' + '-' + ' ' + CAST(bdt1_Tier2.CoPayMaxAmount as varchar) + ' ' + '/' + ' ' + CAST(bd1.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd1.Copa
yMaxAmount as varchar))       
  ...
  WHEN bdt1_Tier2.TierID IS NOT NULL AND bdt1_Tier1.TierID IS NOT NULL       
    ...
    bd1.CopayMinAmount <> bd1.CopayMaxAmount and bd1.CopayMinAmount IS NOT NULL and bd1.CopayMaxAmount IS NOT NULL      
     THEN         
 (Cast(bdt1_Tier1.CoPayMinAmount AS varchar) + ' ' + '-' + ' ' + CAST(bdt1_Tier1.CoPayMaxAmount AS varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CopayMinAmount as varchar)+' ' + '-' + ' ' + CAST(bdt1_Tier2.CoPayMaxAmount as varchar) + ' ' + '/' + ' ' + CAST(b
d1.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd1.CopayMaxAmount as varchar))       
...
d2.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd2.CopayMaxAmount as varchar))       
 ...
 (CAST(bd2.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd2.copayMaxAmount as varchar))      
  ...
  WHEN bdt1_Tier2.TierID IS NOT NULL AND bdt1_Tier1.TierID IS NOT NULL       
     ...
     THEN  (Cast(bdt1_Tier1.CoInsMinPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CoInsMinPercent as varchar)   + ' ' + '-' + ' '+ CAST(bdt1_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + ' ' +          CAST(bd1.CoInsuranceMinPercent as varchar) +
...
ast(bd1.CoInsuranceMaxPercent as varchar))       
     ...
     AND bd1.CoInsuranceMaxPercent IS NOT NULL      
     THEN        
  (Cast(bdt1_Tier1.CoInsMinPercent AS varchar)+ ' '+ '-' + ' '+ CAST(bdt1_Tier1.CoInsMaxPercent as varchar)  + ' '+ '/' + ' ' +CAST(bdt1_Tier2.CoInsMinPercent as varchar) + ' ' + '-' + ' ' +       CAST(bdt1_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + 
...
' + CAST(bd1.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' + CAST(bd1.CoInsuranceMaxPercent as varchar))       
 ...
 (CAST(bd1.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' + CAST(bd1.CoInsuranceMaxPercent as varchar))      
  ...
  WHEN bdt2_Tier2.TierID IS NOT NULL AND bdt2_Tier1.TierID IS NOT NULL       
     ...
     THEN  (Cast(bdt2_Tier1.CoInsMinPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CoInsMinPercent as varchar)   + ' ' + '-' + ' '+ CAST(bdt2_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + ' ' +          CAST(bd2.CoInsuranceMinPercent as varchar) +
 ...
 (Cast(bdt2_Tier1.CoInsMinPercent AS varchar)+ ' '+ '-' + ' '+ CAST(bdt2_Tier1.CoInsMaxPercent as varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CoInsMinPercent as varchar) + ' ' + '/' + ' ' + CAST(bd2.CoInsuranceMinPercent as    varchar) + ' ' + '-' + ' ' + C
ast(bd2.CoInsuranceMaxPercent as varchar))       
     ...
     AND bd2.CoInsuranceMaxPercent IS NOT NULL      
     THEN        
  (Cast(bdt2_Tier1.CoInsMinPercent AS varchar)+ ' '+ '-' + ' '+ CAST(bdt2_Tier1.CoInsMaxPercent as varchar)  + ' '+ '/' + ' ' +CAST(bdt2_Tier2.CoInsMinPercent as varchar) + ' ' + '-' + ' ' +      CAST(bdt2_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + '
 ...
 (CAST(bd2.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' + CAST(bd2.CoInsuranceMaxPercent as varchar))      
  ...
  Getdate() as CreateDate          
        ...
        INNER JOIN [PlanType] [PT] WITH(NOLOCK)           
          ...
          INNER JOIN  dbo.#Temp_HospitalCopay [GPlan]            
  ...
  Drop table dbo.#Temp_HospitalCopay