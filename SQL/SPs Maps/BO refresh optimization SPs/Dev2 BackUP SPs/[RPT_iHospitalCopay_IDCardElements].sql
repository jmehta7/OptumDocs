   ...
   *  and make it non cluster and addedidentity column and make it primary key  and added insert into statemnet  
   */    
       
CREATE Proc [dbo].[RPT_iHospitalCopay_IDCardElements]              
AS              
-----Extract Table              
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Temp_HospitalCopay_IDCardElements]') AND type in (N'U'))              
  DELETE FROM [dbo].[Temp_HospitalCopay_IDCardElements]       
    
INSERT INTO [dbo].[Temp_HospitalCopay_IDCardElements] (BenefitID,InpatientHospitalCopay,PhysicianCopay,SpecialistCopay,EmergencyCopay, PhysicianCoinsurance, SpecialistCoinsurance, EmergencyCoinsurance, CreateBy, CreateDate)  
...
+ Cast(bd1.CopayMaxAmount as varchar))           
 ...
 (Cast(bdt1_Tier1.CoPayMinAmount AS varchar)+ ' '+ '-' + ' '+ CAST(bdt1_Tier1.CoPayMaxAmount as varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CopayMinAmount as varchar) + ' ' + '/' + ' ' + CAST(bd1.CopayMinAmount as    varchar) + ' ' + '-' + ' ' + Cast(bd1.Co
payMaxAmount as varchar))           
     ...
     AND bd1.CopayMaxAmount IS NOT NULL          
     THEN            
  (Cast(bdt1_Tier1.CoPayMinAmount AS varchar)+ ' '+ '-' + ' '+ CAST(bdt1_Tier1.CoPayMaxAmount as varchar)  + ' '+ '/' + ' ' +CAST(bdt1_Tier2.CopayMinAmount as varchar) + ' ' + '-' + ' ' + CAST(bdt1_Tier2.CoPayMaxAmount as varchar) + ' ' + '/' + ' ' + CAST
  
    
      
        
(bd1.CopayMinAmount as varchar) + ' ' + '-' + ' ' + Cast(bd1.CopayMaxAmount as varchar))           
  ...
  bdt1_Tier1.CoPayMaxAmount AND bd1.CopayMinAmount = bd1.CopayMaxAmount and bd1.CopayMinAmount IS NOT NULL          
     THEN             
  (Cast(bdt1_Tier1.CoPayMinAmount AS varchar)+' '+ '-' + ' '+CAST(bdt1_Tier1.CopayMaxAmount as varchar) +          
  ' '+ '/' + ' ' +CAST(bdt1_Tier2.CopayMinAmount as varchar)+' ' + '-' + ' ' + CAST(bdt1_Tier2.CoPayMaxAmount as varchar) + ' ' + '/' + ' ' + CAST(bd1.copayMinamount as varchar))           
 ...
 (Cast(bdt1_Tier1.CoPayMinAmount AS varchar)+ ' ' + '-' + ' '+ CAST(bdt1_Tier1.CoPayMaxAmount AS varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CopayMinAmount as varchar) + ' ' + '/' + ' ' + CAST(bd1.copayMinamount as varchar))           
  ...
  WHEN bdt1_Tier2.TierID IS NOT NULL AND bdt1_Tier1.TierID IS NOT NULL           
     ...
     THEN             
  (Cast(bdt1_Tier1.CoPayMinAmount AS varchar)+ ' ' + '-' + ' '+ CAST(bdt1_Tier1.CoPayMaxAmount AS varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CopayMinAmount as varchar) + ' ' + '/' + ' ' + CAST(bd1.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd1.Cop
ayMaxAmount as varchar))        
  ...
  WHEN bdt1_Tier2.TierID IS NOT NULL AND bdt1_Tier1.TierID IS NOT NULL           
     ...
     THEN             
 (Cast(bdt1_Tier1.CoPayMinAmount AS varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CopayMinAmount as varchar)+' ' + '-' + ' ' + CAST(bdt1_Tier2.CoPayMaxAmount as varchar) + ' ' + '/' + ' ' + CAST(bd1.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd1.Cop
ayMaxAmount as varchar))           
...
bd1.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd1.CopayMaxAmount as varchar))           
 ...
 (CAST(bd1.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd1.copayMaxAmount as varchar))          
  ...
  WHEN bdt2_Tier2.TierID IS NOT NULL AND bdt2_Tier1.TierID IS NOT NULL           
     ...
     THEN  (Cast(bdt2_Tier1.CoPayMinAmount AS varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CopayMinAmount as varchar)   + ' ' + '-' + ' '+ CAST(bdt2_Tier2.CoPayMaxAmount as varchar) + ' ' + '/' + ' ' + CAST(bd2.copayMinamount   as varchar) + ' ' + '-' + ' '
...
+ Cast(bd2.CopayMaxAmount as varchar))           
 ...
 (Cast(bdt2_Tier1.CoPayMinAmount AS varchar)+ ' '+ '-' + ' '+ CAST(bdt2_Tier1.CoPayMaxAmount as varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CopayMinAmount as varchar) + ' ' + '/' + ' ' + CAST(bd2.CopayMinAmount as    varchar) + ' ' + '-' + ' ' + Cast(bd2.Co
payMaxAmount as varchar))           
...
(bd2.CopayMinAmount as varchar) + ' ' + '-' + ' ' + Cast(bd2.CopayMaxAmount as varchar))           
  ...
  bdt2_Tier1.CoPayMaxAmount AND bd2.CopayMinAmount = bd2.CopayMaxAmount and bd2.CopayMinAmount IS NOT NULL          
     THEN             
  (Cast(bdt2_Tier1.CoPayMinAmount AS varchar)+' '+ '-' + ' '+CAST(bdt2_Tier1.CopayMaxAmount as varchar) +          
  ' '+ '/' + ' ' +CAST(bdt2_Tier2.CopayMinAmount as varchar)+' ' + '-' + ' ' + CAST(bdt2_Tier2.CoPayMaxAmount as varchar) + ' ' + '/' + ' ' + CAST(bd2.copayMinamount as varchar))           
 ...
 (Cast(bdt2_Tier1.CoPayMinAmount AS varchar)+ ' ' + '-' + ' '+ CAST(bdt2_Tier1.CoPayMaxAmount AS varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CopayMinAmount as varchar) + ' ' + '/' + ' ' + CAST(bd2.copayMinamount as varchar))           
  ...
  WHEN bdt2_Tier2.TierID IS NOT NULL AND bdt2_Tier1.TierID IS NOT NULL           
     ...
     AND bd2.CopayMaxAmount is not null          
     THEN             
  (Cast(bdt2_Tier1.CoPayMinAmount AS varchar)+ ' ' + '-' + ' '+ CAST(bdt2_Tier1.CoPayMaxAmount AS varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CopayMinAmount as varchar) + ' ' + '/' + ' ' + CAST(bd2.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd2.Cop
ayMaxAmount as varchar))           
  ...
  WHEN bdt2_Tier2.TierID IS NOT NULL AND bdt2_Tier1.TierID IS NOT NULL           
     ...
     THEN             
 (Cast(bdt2_Tier1.CoPayMinAmount AS varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CopayMinAmount as varchar)+' ' + '-' + ' ' + CAST(bdt2_Tier2.CoPayMaxAmount as varchar) + ' ' + '/' + ' ' + CAST(bd2.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd2.Copa
yMaxAmount as varchar))           
  ...
  WHEN bdt2_Tier2.TierID IS NOT NULL AND bdt2_Tier1.TierID IS NOT NULL           
    ...
    bd2.CopayMinAmount <> bd2.CopayMaxAmount and bd2.CopayMinAmount IS NOT NULL and bd2.CopayMaxAmount IS NOT NULL          
     THEN             
 (Cast(bdt2_Tier1.CoPayMinAmount AS varchar) + ' ' + '-' + ' ' + CAST(bdt2_Tier1.CoPayMaxAmount AS varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CopayMinAmount as varchar)+' ' + '-' + ' ' + CAST(bdt2_Tier2.CoPayMaxAmount as varchar) + ' ' + '/' + ' ' + CAST(b
d2.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd2.CopayMaxAmount as varchar))           
 ...
 (CAST(bd2.copayMinamount as varchar) + ' ' + '-' + ' ' + CAST(bd2.copayMaxAmount as varchar))          
  ...
  THEN  (Cast(bdt1_Tier1.CoInsMinPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CoInsMinPercent as varchar)   + ' ' + '/' + ' ' + CAST(bd1.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' +           
  ...
  WHEN bdt1_Tier2.TierID IS NOT NULL AND bdt1_Tier1.TierID IS NOT NULL           
     ...
     THEN  (Cast(bdt1_Tier1.CoInsMinPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CoInsMinPercent as varchar)   + ' ' + '-' + ' '+ CAST(bdt1_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + ' ' +           
 ...
 (Cast(bdt1_Tier1.CoInsMinPercent AS varchar)+ ' '+ '-' + ' '+ CAST(bdt1_Tier1.CoInsMaxPercent as varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CoInsMinPercent as varchar) + ' ' + '/' + ' ' + CAST(bd1.CoInsuranceMinPercent as    varchar) + ' ' + '-' + ' ' + C
ast(bd1.CoInsuranceMaxPercent as varchar))           
     ...
     AND bd1.CoInsuranceMaxPercent IS NOT NULL          
     THEN            
  (Cast(bdt1_Tier1.CoInsMinPercent AS varchar)+ ' '+ '-' + ' '+ CAST(bdt1_Tier1.CoInsMaxPercent as varchar)  + ' '+ '/' + ' ' +CAST(bdt1_Tier2.CoInsMinPercent as varchar) + ' ' + '-' + ' ' +           
  CAST(bdt1_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + ' ' + CAST(bd1.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' + Cast(bd1.CoInsuranceMaxPercent as varchar))           
  ...
  bdt1_Tier1.CoInsMaxPercent AND bd1.CoInsuranceMinPercent = bd1.CoInsuranceMaxPercent and bd1.CoInsuranceMinPercent IS NOT NULL          
     THEN             
  (Cast(bdt1_Tier1.CoInsMinPercent AS varchar)+' '+ '-' + ' '+CAST(bdt1_Tier1.CoInsMaxPercent as varchar) +          
  ' '+ '/' + ' ' +CAST(bdt1_Tier2.CoInsMinPercent as varchar)+' ' + '-' + ' ' + CAST(bdt1_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + ' ' + CAST(bd1.CoInsuranceMinPercent as varchar))           
 ...
 (Cast(bdt1_Tier1.CoInsMinPercent AS varchar)+ ' ' + '-' + ' '+ CAST(bdt1_Tier1.CoInsMaxPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CoInsMinPercent as varchar) + ' ' + '/' + ' ' + CAST(bd1.CoInsuranceMinPercent as varchar))           
  ...
  WHEN bdt1_Tier2.TierID IS NOT NULL AND bdt1_Tier1.TierID IS NOT NULL           
     ...
     AND bd1.CoInsuranceMaxPercent is not null          
     THEN             
  (Cast(bdt1_Tier1.CoInsMinPercent AS varchar)+ ' ' + '-' + ' '+ CAST(bdt1_Tier1.CoInsMaxPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CoInsMinPercent as varchar) + ' ' + '/' + ' ' + CAST(bd1.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' + CA
ST(bd1.CoInsuranceMaxPercent as varchar))           
  ...
  WHEN bdt1_Tier2.TierID IS NOT NULL AND bdt1_Tier1.TierID IS NOT NULL           
     ...
     THEN             
 (Cast(bdt1_Tier1.CoInsMinPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt1_Tier2.CoInsMinPercent as varchar)+' ' + '-' + ' ' + CAST(bdt1_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + ' ' + CAST(bd1.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' + CAS
T(bd1.CoInsuranceMaxPercent as varchar))           
  ...
  WHEN bdt1_Tier2.TierID IS NOT NULL AND bdt1_Tier1.TierID IS NOT NULL           
    ...
    bd1.CoInsuranceMinPercent <> bd1.CoInsuranceMaxPercent and bd1.CoInsuranceMinPercent IS NOT NULL and bd1.CoInsuranceMaxPercent IS NOT NULL          
     THEN             
 (Cast(bdt1_Tier1.CoInsMinPercent AS varchar) + ' ' + '-' + ' ' + CAST(bdt1_Tier1.CoInsMaxPercent AS varchar)+           
 ' '+ '/' + ' ' +CAST(bdt1_Tier2.CoInsMinPercent as varchar)+' ' + '-' + ' ' + CAST(bdt1_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + ' ' + CAST(bd1.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' + CAST(bd1.CoInsuranceMaxPercent as varchar))      
 ...
 (CAST(bd1.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' + CAST(bd1.CoInsuranceMaxPercent as varchar))          
  ...
  THEN  (Cast(bdt2_Tier1.CoInsMinPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CoInsMinPercent as varchar)   + ' ' + '/' + ' ' + CAST(bd2.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' +           
  ...
  WHEN bdt2_Tier2.TierID IS NOT NULL AND bdt2_Tier1.TierID IS NOT NULL           
     ...
     THEN  (Cast(bdt2_Tier1.CoInsMinPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CoInsMinPercent as varchar)   + ' ' + '-' + ' '+ CAST(bdt2_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + ' ' +           
...
Cast(bd2.CoInsuranceMaxPercent as varchar))           
     ...
     AND bd2.CoInsuranceMaxPercent IS NOT NULL          
     THEN            
  (Cast(bdt2_Tier1.CoInsMinPercent AS varchar)+ ' '+ '-' + ' '+ CAST(bdt2_Tier1.CoInsMaxPercent as varchar)  + ' '+ '/' + ' ' +CAST(bdt2_Tier2.CoInsMinPercent as varchar) + ' ' + '-' + ' ' +           
  CAST(bdt2_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + ' ' + CAST(bd2.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' + Cast(bd2.CoInsuranceMaxPercent as varchar))           
 ...
 (Cast(bdt2_Tier1.CoInsMinPercent AS varchar)+ ' ' + '-' + ' '+ CAST(bdt2_Tier1.CoInsMaxPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CoInsMinPercent as varchar) + ' ' + '/' + ' ' + CAST(bd2.CoInsuranceMinPercent as varchar))           
  ...
  WHEN bdt2_Tier2.TierID IS NOT NULL AND bdt2_Tier1.TierID IS NOT NULL           
     ...
     AND bd2.CoInsuranceMaxPercent is not null          
     THEN             
  (Cast(bdt2_Tier1.CoInsMinPercent AS varchar)+ ' ' + '-' + ' '+ CAST(bdt2_Tier1.CoInsMaxPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CoInsMinPercent as varchar) + ' ' + '/' + ' ' + CAST(bd2.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' + CA
ST(bd2.CoInsuranceMaxPercent as varchar))           
  ...
  WHEN bdt2_Tier2.TierID IS NOT NULL AND bdt2_Tier1.TierID IS NOT NULL           
     ...
     THEN             
 (Cast(bdt2_Tier1.CoInsMinPercent AS varchar)+ ' '+ '/' + ' ' +CAST(bdt2_Tier2.CoInsMinPercent as varchar)+' ' + '-' + ' ' + CAST(bdt2_Tier2.CoInsMaxPercent as varchar) + ' ' + '/' + ' ' + CAST(bd2.CoInsuranceMinPercent as varchar) + ' ' + '-' + ' ' + CAS
T(bd2.CoInsuranceMaxPercent as varchar))           
 ...
 User as CreateBy,              
  Getdate() as CreateDate              
        ...
        INNER JOIN [Plan] [P] WITH(NOLOCK)               
              ON  [CNT].[ContractID] = [P].[ContractID]         
              --AND p.IsActive = 1              
